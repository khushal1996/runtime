...
enum CorInfoType
{
    ...
    CORINFO_TYPE_HALF            = 0xe,
    CORINFO_TYPE_FLOAT           = 0xf,
    CORINFO_TYPE_DOUBLE          = 0x10,
    CORINFO_TYPE_STRING          = 0x11,         // Not used, should remove
    CORINFO_TYPE_PTR             = 0x12,
    CORINFO_TYPE_BYREF           = 0x13,
    CORINFO_TYPE_VALUECLASS      = 0x14,
    CORINFO_TYPE_CLASS           = 0x15,
    CORINFO_TYPE_REFANY          = 0x16,
