...
enum ReadyToRunInstructionSet
{
    ...
    READYTORUN_INSTRUCTION_AvxVnniInt8=56,
    READYTORUN_INSTRUCTION_AvxVnniInt8_V512=57,
    READYTORUN_INSTRUCTION_AvxVnniInt16=58,
    READYTORUN_INSTRUCTION_AvxVnniInt16_V512=59,
