...
// It will be set in InitJITHelpers2
    ...
    DYNAMICJITHELPER(CORINFO_HELP_DBL2INT,      JIT_Dbl2Int,        CORINFO_HELP_SIG_8_STACK)
    ...
    DYNAMICJITHELPER(CORINFO_HELP_DBL2UINT,     JIT_Dbl2UInt,       CORINFO_HELP_SIG_8_STACK)
    JITHELPER(CORINFO_HELP_DBL2UINT_OVF,        JIT_Dbl2UIntOvf,    CORINFO_HELP_SIG_8_STACK)
    JITHELPER(CORINFO_HELP_FLT2UINT,            JIT_Flt2UInt,       CORINFO_HELP_SIG_8_STACK)
